...
class BBCode {
  ...
  public function __construct () {
    ...
    // Replace [button=http://www.google.com/ type=success]A link to google[/button] with <a href="http://www.google.com/" class="btn btn-success">A link to google</a>
    $this->bbcode_table["/\[button=(.*?) type=(.*?)\](.*?)\[\/button\]/is"] = function ($match) {
      switch ($match[2]) {
        case 'success':
      ...
      return "<a href=\"$match[1]\" class=\"$class\">$match[3]</a>"; 
    };
